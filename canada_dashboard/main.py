...
@st.cache_data
def read_data():
    """Read the data file of the Canada population time series.
       Also performs simple feature engineering for Quarter & Year columns.
    Returns:
        df: Dataframe containing the CSV file
    """
...
def display_dashboard(start_mask, end_mask, location):
    """Display the Canada population dashboard.
       Required correct input beforehand. 
    """
...
if __name__ == '__main__':
    ...
    else: # Else display tabs (dashboard)
        display_dashboard(start_mask, end_mask, location) 